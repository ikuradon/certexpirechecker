...
class InstancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post instances_url, params: { instance: { domain: @instance.domain, not_after: @instance.not_after, not_before: @instance.not_before, note: @instance.note, updated_at: @instance.updated_at } }
    end
  ...
  test "should update instance" do
    patch instance_url(@instance), params: { instance: { domain: @instance.domain, not_after: @instance.not_after, not_before: @instance.not_before, note: @instance.note, updated_at: @instance.updated_at } }
